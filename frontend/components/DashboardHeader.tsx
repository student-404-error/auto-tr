...
export default function DashboardHeader({ symbol, markPrice, totalEquity, serverOnline }: DashboardHeaderProps) {
    ...
    <div className="px-5 py-6 md:px-8 md:py-8 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800/50 bg-background-dark/95 backdrop-blur sticky top-0 z-40">
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2">
          <h1 className="text-2xl font-bold text-white tracking-tight">{pair}</h1>
          <span className="px-2 py-0.5 rounded text-xs font-bold bg-slate-700 text-slate-300">PERP</span>
        </div>
